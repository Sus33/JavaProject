...
public class UserStorage {
    ...
    public User getUserByName(String email, String password) {
    ...
    public UserType getUserByType(String username, String password) {
        for (User user : users.values ()) {
            if (user.getEmail ().equalsIgnoreCase (username) && user.getPassword ().equalsIgnoreCase (password)) {
                return user.getType ();
            }
        }
        return null;
