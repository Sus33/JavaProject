...
public class UserManager {
    ...
    public void add(User user) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement ("insert into user(name,surname,email,password,user_type) values (?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
