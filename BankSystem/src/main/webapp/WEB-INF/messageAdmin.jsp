        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="topbar-content">
                    ...
                    <a href="www.armenianbank@gmail.com">armenianbank@gmail.com</a>
                </div>
                <div class="topbar-content">
    ...
    <nav class="navbar navbar-expand-md main-nav bg-dark-navy">
        <div class="container">
            ...
            <a class="navbar-brand" href="/">
                ...
                <h2 class="zzz">Online</h2><img src="img/SVM-logo.png" width="600"><h2 class="zzz">Banking</h2>
...
<div class="main-wrapper home">
                ...
                <div class="col-lg-8">
                    ...
                    <form class="">
                        ...
                        <div class="sectionTitle" style="text-align: center">
                            <h1>Send Message</h1><spring:form action="/sendMessage" modelAttribute="message" method="post">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3020.891169502999!2d43.836157315060035!3d40.786406679323825!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4041fbed15cdb0cb%3A0xea64b7ee5515c5de!2sGyumri+Technology+Center!5e0!3m2!1sru!2s!4v1516788863773" width="1340" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
